...
- [x] Explain what a token is used for.
 ...
 -  A token is something the server returns as a key to get into authenticated pages. 

- [x] What steps can you take in your web apps to keep your data secure?

 -  We can do this by keeping software up to date, enforcing a strong password policies, Using a secure host, Backing up data, Scanning our website for vulnerabilities, etc…

- [x] Describe how web servers work.

 -  Web servers control how web users access hosted files. Servers understand URLs and HTTP so it can be accessed through the domain names or websites it stores, and delivers their content to the end user.
